...
export default function AIPanel({ selectedLanguage }) {
  ...
  const handleAIAction = async (action) => {
    ...
    // Later you will replace this with your Gemini API call
    setTimeout(() => {
      setResponse(
        `AI suggestion for "${action}":\n\n` +
  ...
  const handleGenerate = async () => {
    ...
    // Later: send prompt + current code to Gemini
    setTimeout(() => {
      setResponse(
        `AI generated code:\n\n` +
        `// Code generated from:\n` +
  ...
  const keepChanges = () => {
    // Later we will send the AI response back to Monaco
    console.log("Keep changes:", response);
          ...
          <>
            ...
            <div className="space-y-2 p-4">
              ...
              <button
                ...
                className="w-full rounded-lg border border-gray-800 bg-[#11161d] px-4 py-3 text-left text-sm transition hover:border-blue-500/40 hover:bg-[#151b23]"
              >
              ...
              <button
                onClick={() => handleAIAction(`Convert to ${selectedLanguage}`)}
                className="w-full rounded-lg border border-gray-800 bg-[#11161d] px-4 py-3 text-left text-sm transition hover:border-blue-500/40 hover:bg-[#151b23]"
              >
            ...
            <div className="border-t border-gray-800 p-4">
              ...
              <button
                ...
                className="mt-2 w-full rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-medium transition hover:bg-blue-500 disabled:cursor-not-allowed disabled:opacity-40"
              >
            ...
            <div className="border-t border-gray-800 p-4">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 rounded-lg border border-gray-700 px-4 py-2 text-sm text-gray-400 transition hover:bg-gray-800 hover:text-white"
                >
                  Discard
                </button>
